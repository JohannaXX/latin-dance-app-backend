...
router.patch('/user/:id/update', authMiddleware.isAuthenticated, userController.update);
router.get('/user/:id/edit', authMiddleware.isAuthenticated, userController.edit);
...
router.get('/post/:id/edit', authMiddleware.isAuthenticated, postController.edit);
